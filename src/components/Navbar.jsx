...
class NavbarTailwind extends Component {
  render() {
    return (
      <header>
        <nav className="navbar navbar-expand-lg shadow-md py-2 bg-dark-bg flex items-center w-full justify-between fixed">
          <div className="px-6 w-full flex flex-wrap items-center justify-between">
            <div className="flex items-center">
              <button
                className="navbar-toggler border-0 py-3 lg:hidden leading-none text-xl bg-transparent text-white hover:text-yellow-select focus:text-yellow-select transition-shadow duration-150 ease-in-out mr-2"
                type="button"
            ...
            <div className="navbar-collapse collapse grow items-center" id="navbarSupportedContentY">
              <ul className="navbar-nav mr-auto lg:flex lg:flex-row">
                ...
                <li className="nav-item mb-2 lg:mb-0">
                  <a className="nav-link block pr-2 lg:px-2 text-white hover:text-yellow-select focus:text-yellow-select transition duration-150 ease-in-out" href="#Footer" data-mdb-ripple="true" data-mdb-ripple-color="light">Contato</a>
                </li>
              </ul>
            </div>
          </div>
